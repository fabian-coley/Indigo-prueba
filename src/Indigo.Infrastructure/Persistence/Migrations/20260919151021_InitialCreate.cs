        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Precio_Positivo", "\"Precio\" > 0");
                    table.CheckConstraint("CK_Products_Stock_No_Negativo", "\"Stock\" >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Sales_Total_Positivo", "\"Total\" > 0");
                    table.ForeignKey(
                        name: "FK_Sales_AspNetUsers_UsuarioId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_SaleItems_Cantidad_Positiva", "\"Cantidad\" > 0");
                    table.CheckConstraint("CK_SaleItems_PrecioUnitario_Positivo", "\"PrecioUnitario\" > 0");
                    table.CheckConstraint("CK_SaleItems_Subtotal_No_Negativo", "\"Subtotal\" >= 0");
                    table.ForeignKey(
